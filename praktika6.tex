...
\textbf{Maria}: Al realizar la práctica pudimos ver claramente como funciona el k-means. El algoritmo es bastante sencillo y fácil de entender, pero al implementarlo pudimos visualizar algunos aspectos con mas claridad, por ejemplo haciendo las gráficas se ve claramanete que al variar el k cambian el SSE y Silhouette.
